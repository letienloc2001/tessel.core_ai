...
def detect_product() -> Response:
    ...
    prediction = current_app.models["PRODUCT_DETECTION"](images)
    result = []
...
def detect_milkcan() -> Response:
    ...
    images = input_json['images']
    prediction = current_app.models["CAN_DETECTION"](images)
...
def detect_shelf() -> Response:
    ...
    images = input_json['images']
    prediction = current_app.models["SHELF_DETECTION"](images)
